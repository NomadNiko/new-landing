...
export async function sendContactFormSubmission(formData, retryAttempt = 0) {
  const { firstName, lastName, email, application, revenueCatId, message } = formData;
      ...
      <div class="content">
        ...
        <div class="info-box">
          ...
          <div class="field">
            ...
            <div class="field-value">${escapeHtml(application || 'Nomadsoft')}</div>
          </div>
          ${revenueCatId ? `<div class="field">
            <span class="field-label">RevenueCat ID:</span>
            <div class="field-value">${escapeHtml(revenueCatId)}</div>
          </div>` : ''}
        </div>
...
Name: ${fullName}
Email: ${email}
Application: ${application || 'Nomadsoft'}
${revenueCatId ? `RevenueCat ID: ${revenueCatId}` : ''}
